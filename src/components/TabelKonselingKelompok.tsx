                ...
                {selectedDetail.link_foto_kegiatan && (
                  <div className="p-3.5 bg-pink-50 rounded-2xl border border-pink-200 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-pink-900 text-xs">Dokumentasi Foto Kegiatan:</span>
                    ...
                    <div className="flex justify-center">
                      <img
                        ...
                        alt="Foto Kegiatan Konseling Kelompok"
                        className="max-h-48 rounded-xl border border-pink-200 object-contain shadow-sm bg-white"
                        onError={(e) => {
